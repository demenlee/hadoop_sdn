...
switches = ('0000000000000001', '0000000000000002', '0000000000000003')
hosts = ('00:00:00:00:00:21', '00:00:00:00:00:22', '00:00:00:00:00:23', '00:00:00:00:00:24')
'''
switches = ( dpid )  ; dpid is str of datapathID
hosts = ( mac_address )
'''

class SwitchTest31(simple_switch_13.SimpleSwitch13):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]

    
    def __init__(self, *args, **kwargs):
        super(SwitchTest31, self).__init__(*args, **kwargs)
        # self.ipv4_to_port{}
    ...
    def _packet_in_handler(self, ev):
        ...
        if dpid == switches[1]:
            if(src == hosts[0] and dst == hosts[1]):
                out_port = 3
                self.add_flow_mod(datapath, buffer_id, ofproto, flow_info, parser, out_port)
                return
